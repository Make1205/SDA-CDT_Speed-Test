...
`online/` is the runtime boundary. It contains `common/` table definitions and bounded-uniform helpers, `frodo/` reference backend code, `falcon/` AVX2 code, committed final table artifacts under `tables/`, plus `tests/` and `benchmarks/`.
