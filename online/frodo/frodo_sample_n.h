...
int frodo_original_sample_n_from_words(uint16_t *out,const uint16_t *word_source,size_t n,const sdat_table *table);
...
uint16_t frodo_original_lookup_magnitude(uint16_t x,const sdat_table*t);
#endif
