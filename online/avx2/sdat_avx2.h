...
void sda_cdt_avx2_lookup_u8_batch(const uint8_t*x,size_t n,const uint8_t*t,size_t tn,uint32_t*out);
void sda_cdt_avx2_lookup_u72_batch(const sdat_u72*x,size_t n,const sdat_u72*t,size_t tn,uint32_t*out);
void original_cdt_avx2_lookup_u72_reverse_batch(const sdat_u72*x,size_t n,const sdat_u72*t,size_t tn,uint32_t*out);
