...
uint32_t online_lookup_u8(uint8_t x,const uint8_t*t,size_t threshold_count);
...
uint32_t online_lookup_u72_reverse_tail(sdat_u72 x,const sdat_u72*t,size_t threshold_count);
