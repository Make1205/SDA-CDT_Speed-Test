...
static inline uint64_t bench_timer_mark(void){__asm__ __volatile__("":::"memory");_mm_lfence();return __rdtsc();}
...
static inline uint64_t bench_timer_mark(void){return bench_clock();}
