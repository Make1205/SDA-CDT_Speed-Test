...
static double bench_one(const sda_table *t, const char *kind) {
    ...
    FILE *csv = fopen("offline/generated/sda_cycle_benchmark.csv", "a");
    if (csv) {
    ...
    FILE *raw = fopen("offline/generated/sda_cycle_raw_samples.csv", "a");
    if (raw) {
...
int main(int argc, char **argv) {
    ...
    FILE *csv = fopen("offline/generated/sda_cycle_benchmark.csv", "w");
    if (csv) {
    ...
    FILE *raw = fopen("offline/generated/sda_cycle_raw_samples.csv", "w");
    if (raw) {
